...
export default function SidebarContent({
  ...
  return (
    <>
        ...
        <div className="px-2 mb-2 shrink-0">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[10px] text-[var(--text-ghost)]">click to manage</div>
            </div>
            <ChevronDown size={12} strokeWidth={2} className="text-[var(--text-ghost)] shrink-0" />
          </button>
        </div>
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
              {channels.length > 0 ? (
                  ...
                  {searchOpen && (
                    <div className="mx-2 mb-2 shrink-0">
                      <div className="flex items-center gap-2 bg-[var(--bg-input)] border border-[var(--border)] rounded-md px-2.5 py-1.5 focus-within:border-[var(--teal-700)]">
                        ...
                        />
                        {searchTerm && (
                          <button className={iconBtnCls} onClick={onSearchClear}>
                            <X size={11} />
                          </button>
                        )}
                      </div>
                  ...
                  >
                    {channels.map((ch) => (
                      <li key={ch.id} role="listitem">
                        ...
                        >
                          <Hash size={13} strokeWidth={2} className="shrink-0" />
                ...
                <div className="flex flex-col items-center justify-center gap-3 flex-1 px-4 text-center">
                  <Building2 size={28} strokeWidth={1} className="text-[var(--text-ghost)]" />
      ...
      {/* Modals */}
      {panelOpen && <InstituteSidebar onClose={onClosePanel} onStartP2P={onStartP2P} />}
      {createModalOpen && (
        <CreateChannelModal onClose={onCloseCreate} onConfirm={handleCreateChannel} />
      )}
      {isProfileOpen && <UserProfilePanel userId={user.id} onClose={onCloseProfile} />}
    </>
  );
}