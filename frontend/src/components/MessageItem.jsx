...
function MessageItem({
	...
	return (
		<div className={`message-item ${isMine ? 'mine' : 'theirs'}`}>
			{!isMine && (
				<button className='message-avatar-btn' onClick={handleUserClick} title={`View ${message.username}'s profile`}>
					{theirPicture
						? <img src={theirPicture} alt={message.username} className='message-avatar message-avatar--img' />
			...
			<div className='message-content'>
				{!isMine && (
					<button className='message-author-btn' onClick={handleUserClick} title={`View ${message.username}'s profile`}>
						{message.username}
					</button>
				)}
				...
				<div className='message-bubble-wrap'>
					...
					{isMine && !isEditing && (
						<div className='message-action-buttons message-action-buttons--desktop'>
							<button className='message-action-icon' onClick={handleCopy} title={copied ? 'Copied!' : 'Copy'}>
								{copied ? (
							...
							<button className='message-action-icon' onClick={handleStartEdit} title='Edit'>
								<svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
									<path d='M12 20h9'></path>
									<path d='M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z'></path>
								</svg>
							</button>
							<button className={`message-action-icon message-delete ${deleting ? 'deleting' : ''}`} onClick={handleDelete} title='Delete'>
								<svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
					...
					{!isEditing && (
						<div className='message-mobile-menu' ref={menuRef}>
							...
							{menuOpen && (
								<div className={`message-context-menu ${isMine ? 'message-context-menu--mine' : 'message-context-menu--theirs'}`}>
									<button className='message-context-item' onClick={handleCopy}>
										<svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
											<rect x='9' y='9' width='13' height='13' rx='2' ry='2'></rect>
											<path d='M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1'></path>
										</svg>
									...
									{isMine && (
										<>
											<button className='message-context-item' onClick={handleStartEdit}>
												<svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
													<path d='M12 20h9'></path>
													<path d='M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z'></path>
												</svg>
											...
											<button className='message-context-item message-context-item--danger' onClick={handleDelete} disabled={deleting}>
												<svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
													<polyline points='3,6 5,6 21,6' />
													<path d='M19,6l-1,14a2,2,0,0,1-2,2H8a2,2,0,0,1-2-2L5,6' />
													<path d='M10,11v6M14,11v6' />
			...
			{isMine && (
				<button className='message-avatar-btn' onClick={handleUserClick} title={`View ${message.username}'s profile`}>
					{minePicture
						? <img src={minePicture} alt={message.username} className='message-avatar mine-avatar message-avatar--img' />
