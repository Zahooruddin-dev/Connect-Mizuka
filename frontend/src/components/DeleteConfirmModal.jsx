...
export default function DeleteConfirmModal({ message, onConfirm, onCancel }) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 bg-black/50 backdrop-blur-[3px] z-[2200] flex items-center justify-center p-5 animate-[overlay-fade-in_0.2s_ease-out]"
      ...
      >
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl w-full max-w-[360px] shadow-[0_8px_28px_rgba(0,0,0,0.32)] flex flex-col overflow-hidden animate-[modal-pop_0.2s_cubic-bezier(0.16,1,0.3,1)]">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border)]">
            <h2 id="delete-confirm-title" className="text-sm font-medium text-[var(--text-primary)]">
              Delete message
            </h2>
            <button
          ...
          <div className="px-5 py-6">
            ...
            {message.content && (
              <p className="mt-3 text-[12px] text-[var(--text-ghost)] italic text-center line-clamp-2">
