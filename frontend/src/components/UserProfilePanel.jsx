...
const infoLabelCls =
	'text-[11px] font-medium uppercase tracking-[0.06em] text-[var(--text-ghost)]';
const infoValueCls =
								...
								{activeTab === 'profile' && (
									<>
										...
										<div className={`${infoGroupCls} group`}>
											...
											{saveSuccess && (
												<span className='text-[12px] text-[var(--teal-600)]'>
													Username updated
												</span>
											)}
										</div>
										...
										<div className={infoGroupCls}>
											...
											<span className='text-[12px] font-mono text-[var(--text-ghost)]'>
												{userInfo.id}
											</span>
										</div>
								...
								{activeTab === 'account' && (
									<>
										<div className={infoGroupCls}>
											...
											<span className={infoValueCls}>
												<span
													className='w-1.5 h-1.5 rounded-full bg-[var(--teal-600)] shrink-0'
													aria-hidden='true'
												/>
												Active
											</span>
