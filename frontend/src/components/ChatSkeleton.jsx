  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col max-w-[65%] ${mine ? 'items-end' : ''}`}>
        ...
        <div
          className={`shimmer px-3.5 py-2.5 min-h-[38px] flex flex-col justify-center gap-1.5 rounded-2xl ${
...
export default function ChatSkeleton({ isP2P }) {
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden bg-[var(--bg-base)]">
      {/* Header */}
      <div className="h-14 px-4 flex items-center justify-between border-b border-[var(--border)] bg-[var(--bg-surface)] shrink-0">
        <div className="flex items-center gap-2.5">
          {isP2P ? (
            ...
            <>
              <div className="shimmer w-5 h-5 rounded-md" />
      ...
      {/* Input area */}
      <div className="px-4 pt-3 pb-3.5 border-t border-[var(--border)] bg-[var(--bg-surface)] flex flex-col gap-1.5 shrink-0">
        <div className="flex items-center gap-2.5 bg-[var(--bg-input)] border border-[var(--border)] rounded-2xl py-3 pl-4 pr-2">
