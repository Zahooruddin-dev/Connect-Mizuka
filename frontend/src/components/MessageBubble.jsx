	...
	return (
      ...
      `}</style>
			...
			>
				...
				<div
					className={`flex flex-col gap-0.5 max-w-[68%] ${isOwn ? 'items-end' : ''}`}
				>
					{!isOwn && (
				...
				{hovered && isOwn && (
					<button
						className='w-6 h-6 rounded-full flex items-center justify-center shrink-0 mb-0.5 text-red-400 text-[13px] leading-none transition-all duration-150 border border-red-400/20 bg-red-400/8 hover:bg-red-400/15 hover:border-red-400/30 focus-visible:outline-2 focus-visible:outline-red-400'
