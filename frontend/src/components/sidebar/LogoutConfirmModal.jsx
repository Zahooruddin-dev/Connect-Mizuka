...
export default function LogoutConfirmModal({ onConfirm, onCancel }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl w-full max-w-[360px] shadow-[0_8px_28px_rgba(0,0,0,0.32)] flex flex-col overflow-hidden animate-[modal-pop_0.2s_cubic-bezier(0.16,1,0.3,1)]"
        >
          ...
          <div className="px-5 py-6">
            <p className="text-[13px] text-[var(--text-secondary)] leading-relaxed">
              Are you sure you want to sign out? You'll need to log in again to access your channels and messages.
            </p>
          </div>
          ...
          <div className="flex gap-2 px-5 pb-5">
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 text-[13px] font-medium rounded-lg transition-colors focus-visible:outline-2 focus-visible:outline-red-400"
            >
              Sign out
            </button>
            <button
