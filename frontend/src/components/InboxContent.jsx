...
const userItemCls =
	'w-full flex items-center gap-2.5 px-2 py-2 rounded-md text-left transition-colors hover:bg-[var(--bg-hover)] disabled:opacity-60 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-[var(--teal-700)]';
