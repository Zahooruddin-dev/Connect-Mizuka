...
export default function LoginPage() {
  ...
  const [form, setForm] = useState({ email: '', password: '', username: '', role: 'member', code: '', newPassword: '' })
      ...
      <div className="login-card">
        ...
        {view === VIEWS.LOGIN && (
          <form className="login-form" onSubmit={handleLogin} noValidate>
            ...
            <div className="login-links">
              <button type="button" className="login-link" onClick={() => switchView(VIEWS.REGISTER)}>
                Create account
              </button>
              <button type="button" className="login-link" onClick={() => switchView(VIEWS.RESET_REQ)}>
                Forgot password?
              </button>
            </div>
          </form>
        ...
        {view === VIEWS.REGISTER && (
          <form className="login-form" onSubmit={handleRegister} noValidate>
            ...
            <p className="login-sub">You can join an institute after signing up.</p>
            ...
            <div className="login-links">
              <button type="button" className="login-link" onClick={() => switchView(VIEWS.LOGIN)}>
                Back to sign in
              </button>
            </div>
          </form>
        ...
        {view === VIEWS.RESET_CONFIRM && (
          <form className="login-form" onSubmit={handleResetConfirm} noValidate>
            ...
            <label className="login-label" htmlFor="reset-code">Code</label>
            <input
              id="reset-code"
              className="login-input"
              name="code"
            ...
            />
            <label className="login-label" htmlFor="reset-newpw">New password</label>
            <input
              id="reset-newpw"
              className="login-input"
              name="newPassword"
